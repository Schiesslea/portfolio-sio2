        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-300">
              BestMovie est une application web permettant de pouvoir gérer sa cinémathèque. C'est un projet réalisé pendant ma première
              année de BTS SIO en spécialité SLAM. Le but de ce projet était de créer un site qui est connecté à une base de données pour stocker
              les films, les commentaires ou encore les utilisateurs.
            </p>

            <p className="text-gray-600 dark:text-gray-300">
              Ce site a été réalisé avec Bootstrap, un framework front-end open-source. Il fournit une collection d'outils CSS et JavaScript
            ...
            <p className="text-gray-600 dark:text-gray-300 mt-8">
              Ce projet BestMovie m'a permis d'approfondir mes compétences en développement web et en gestion de bases de données.
              J'ai appris à concevoir une application complète avec des fonctionnalités d'inscription d'utilisateurs, d'ajout de contenu,
              et de gestion de données via des formulaires. En travaillant avec Bootstrap, j'ai pu maîtriser un framework front-end pour
